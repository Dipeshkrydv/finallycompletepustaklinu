...
export default function AdminMessagesPage() {
    ...
    const selectUser = (userId) => {
        ...
        router.push(`/dashboard/admin/messages?userId=${userId}`);
    };
            ...
            <div className="w-1/3 bg-white border-r border-gray-200 flex flex-col">
                <div className="p-4 border-b border-gray-200">
                    <h2 className="text-xl font-bold text-gray-800 flex items-center gap-2">
                        <MessageSquare className="w-5 h-5 text-amber-600" /> Inbox
                    </h2>
                </div>
                ...
                {selectedUserId ? (
                    <>
                        ...
                        <form onSubmit={handleSendMessage} className="p-4 bg-white border-t border-gray-200 flex gap-3">
                            ...
                            />
                            <button type="submit" disabled={!newMessage.trim()} className="bg-amber-600 text-white p-3 rounded-full hover:bg-amber-700 transition disabled:opacity-50 shadow-md">
