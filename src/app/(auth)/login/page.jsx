      ...
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md border border-amber-100">
        ...
        <div className="mt-8">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <button onClick={() => signIn('google')} className="flex items-center justify-center px-4 py-2 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition">
            ...
            <button onClick={() => signIn('facebook')} className="flex items-center justify-center px-4 py-2 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition">
